...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
   <h2>Searched post <span class="style18"><%=request.getParameter("p_Name")%></span> Details</h2>
                <p class="style6">&nbsp;</p>
                <p>
...
%>
 ...
 <table border="1" align="center" cellpadding="0" cellspacing="0" >
								...
								<tr>
								        ...
								        <td><div align="center"><span class="style17" style="color:#000000;"><a href="U_Comment1.jsp?p_name=<%=p_Name%>">Comment</a></span></div></td>
								</tr>
								<tr>
