...
.style7 {font-size: 36px; color: #FF00FF; }
.style8 {color: #99FF66}
.style9 {color: #FF0000}
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style6">User-Centric Similarity Search</h1>
      </div>
      <div class="clr"></div>
      <div class="slider">
  ...
  <div class="content">
	...
	<div class="sidebar">
        ...
        <div class="clr"></div>
        <div class="gadget">
          <h2 class="star style8">Admin Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><a href="A_Main.jsp">Home</a></li>
	        <li class="style9"><a href="A_AuthorizeUsers.jsp">View & Authorize Users</a></li>
            <li class="style9"><a href="A_AddCategory.jsp">Add Categories</a></li>
			 <li class="style9"><a href="A_AddProducts.jsp">Add Product Posts by selecting category</a></li>
			<li class="style9"><a href="A_ViewAllPosts.jsp">View all Products with its rank </a></li>
			<li class="style9"><a href="A_ViewPurchasedProducts.jsp">View all Purchased Products </a></li>
            <li class="style9"><a href="A_Billing.jsp">Find Total Bill On Purchased Products </a></li>
			<li class="style9"><a href="A_RTree.jsp">List All Products by R Tree </a></li>
			<li class="style9"><a href="A_ViewComments.jsp">List All reviewed comments on Posts</a></li>
			<li class="style9"><a href="A_SearchList.jsp">List All Search and View Details History</a></li>
			<li class="style9"><a href="A_AllUsersProductSearch.jsp">View All user’s product search  </a></li>
            <li class="style9"><a href="A_ProductsChart.jsp"> View  product Rank chart</a></li>
            <li><span class="style9"><a href="A_SearchRatioChart.jsp">View Search ratio in chart</a></span><a href="A_SearchRatioChart.jsp"><br />
            </a></li>
