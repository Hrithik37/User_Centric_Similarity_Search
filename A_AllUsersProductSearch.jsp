	...
	<table width="426" border="2" align="left" >
		...
		try{
			...
			while(rs.next())
			{
				...
				%>
			 <tr>
				<td colspan="3"><div align="center"><span class="style8">posts Searched Result of </span><span class="style19"> <strong> <%=uname%></strong> </span></div></td>
			</tr>
              <%
			...
			%>
             <tr>
				<td width="171"><input  name="image" type="image" style="width:100px; height:100px;" src="post_Pic.jsp?id=<%=i%>" align="middle"/></td>
                  <td  width="237" height="30" align="center" valign="middle"> <a href="A_AllUserProductSearch1.jsp?name=<%=result%>"> <%out.print(result);%> </a></td>
	      </tr>
			<%	}}}
