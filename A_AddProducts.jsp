...
<form name="s" method="post" enctype="multipart/form-data" action="A_AddProductConf.jsp" onSubmit="return valid()"  ons target="_top">
  ...
  <table width="405" border="0" align="center">
    <tr>
      <td width="165" height="33"><div align="center"><span class="style3 style4 style8">Select the Categorie </span></div></td>
      <td width="230"><label>
    ...
    <tr>
      <td height="36"><div align="center"><span class="style3 style4 style8"> Post Name </span> </div></td>
      <td><label>
	 ...
	 <tr>
      <td height="35"><div align="center"><span class="style3 style4 style8">Price </span></div></td>
      <td><label>
        <input type="text" id="t3" name="price">
      </label></td>
    </tr>
    <tr>
      <td height="51"><div align="center"><span class="style3 style4 style8"> Description </span></div></td>
      <td><label>
    ...
    <tr>
      <td height="38"><div align="center"><span class="style3 style4 style8">  Image </span></div></td>
